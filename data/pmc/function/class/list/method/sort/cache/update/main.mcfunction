...
execute if score #__index__ pmc.var matches 3 run return run function pmc:class/list/method/sort/cache/update/3
execute if score #__index__ pmc.var matches 4 run return run function pmc:class/list/method/sort/cache/update/4
