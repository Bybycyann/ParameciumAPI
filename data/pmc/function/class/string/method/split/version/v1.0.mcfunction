...
function pmc:class/string/method/split/1.1
    execute if score #__i__ pmc.var matches ..0 run return run function pmc:class/string/method/split/1.1.3 with storage pmc:io stack[-1]
    ...
    function pmc:class/string/method/split/1.1.1 with storage pmc:io stack[-1]
    ...
    execute if score #__bool__ pmc.var matches 0 run function pmc:class/string/method/split/1.1.2 with storage pmc:io stack[-1]
