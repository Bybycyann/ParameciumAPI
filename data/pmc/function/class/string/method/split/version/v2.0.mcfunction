...
# 切片函数
function pmc:class/string/method/split_new/1.1
    execute unless function pmc:class/string/method/split_new/predicate/loop_conditions run return 1
    function pmc:class/string/method/split_new/1.1.1 with storage pmc:io stack[-1]
        $data modify storage pmc:io stack[-1].frag set string storage pmc:io stack[-1].strC 0 $(sepLen)
    execute unless function pmc:class/string/method/split_new/predicate/frag_contrast run return run function pmc:class/string/method/split_new/1.1.2
        ...
        function pmc:class/string/method/split_new/1.1.2.1 with storage pmc:io stack[-1]
